...
public class Login_resurse extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Login_resurse frame = new Login_resurse();
    ...
    public Login_resurse() {
        ...
        JLabel lblNewLabel = new JLabel("AUTENTIFICARE ADMINISTRATOR");
        lblNewLabel.setBounds(-20, 10, 652, 88);
        lblNewLabel.setForeground(Color.BLUE);
        lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
        lblNewLabel.setFont(new Font("Segoe UI Black", Font.PLAIN, 35));
        contentPane.add(lblNewLabel);

        JLabel lblNewLabel_4 = new JLabel("RESURSE UMANE");
        lblNewLabel_4.setBounds(-20, 55, 652, 88);
        lblNewLabel_4.setForeground(Color.BLUE);
        lblNewLabel_4.setHorizontalAlignment(SwingConstants.CENTER);
        lblNewLabel_4.setFont(new Font("Segoe UI Black", Font.PLAIN, 35));
        ...
        btnlogin.setBounds(442, 493, 142, 61);
        btnlogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    String sql = "SELECT * FROM utilizatori WHERE tip = 'resurse' AND id_utilizator = '" + user.getText() + "' AND parola = '" + pass.getText().toString() + "'";
                    ResultSet rs = stmt.executeQuery(sql);
                    if(rs.next()) {
                        ResurseUmane i = new ResurseUmane();
                        i.show();
                        center(i);
                        dispose();
        ...
        btnNewButton.setBounds(30, 493, 126, 61);
        ...
        lblNewLabel_3.setBounds(0, 0, 632, 609);
