...
public class Login_receptioner extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Login_receptioner frame = new Login_receptioner();
    ...
    public Login_receptioner() {
        ...
        JLabel lblNewLabel = new JLabel("AUTENTIFICARE RECEPȚIONER");
        ...
        btnlogin.setBounds(430, 519, 142, 61);
        btnlogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    if(rs.next()) {
                        Modul_receptioner fr1 = new Modul_receptioner();
                        fr1.show();
                        center(fr1);
                        dispose();
        ...
        btnNewButton.setBounds(60, 519, 126, 61);
