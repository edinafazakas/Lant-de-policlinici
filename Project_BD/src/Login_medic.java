...
public class Login_medic extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Login_medic frame = new Login_medic();
    ...
    public Login_medic() {
        ...
        JLabel lblNewLabel = new JLabel("AUTENTIFICARE MEDIC");
        lblNewLabel.setBounds(51, 10, 568, 88);
        ...
        btnlogin.setBounds(430, 529, 142, 61);
        btnlogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    String sql = "SELECT * FROM utilizatori WHERE tip = 'medic' AND id_utilizator = '" + user.getText() + "'AND parola = '" + pass.getText().toString() + "'";
                    ResultSet rs = stmt.executeQuery(sql);
                    if(rs.next()) {
                        Modul_medic fr3 = new Modul_medic();
                        fr3.show();
                        center(fr3);
                        dispose();
        ...
        btnNewButton.setBounds(63, 529, 126, 61);
        ...
        lblNewLabel_3.setIcon(new ImageIcon("art/background.png"));
